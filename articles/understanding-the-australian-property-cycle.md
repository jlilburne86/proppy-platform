---
title: "Understanding the Australian Property Cycle"
description: "A practical primer on the phases of Australia’s property cycle—how to read rates, vacancy, listings and approvals—and turn them into repeatable actions."
category: [Cycles]
audience: [Both]
reading_time: "5 min"
...
Cycles are driven by credit conditions, supply pipelines and tenant demand. This primer breaks the cycle into phases and shows which signals to monitor at each stage—and how to turn them into decisions.
...
## Market Context
- Monetary stance: The RBA cash rate target sat at 3.60% on 10 Dec 2025 (RBA). Earlier easing in 2025 improved serviceability modestly but from a higher baseline than 2021–2022.
- Supply: Approvals and commencements were materially below 2021 peaks through 2024–2025 in parts of the country, shaping medium‑term rental pressure (ABS).
- Demand: Migration and employment conditions influence tenant demand and turnover; always read vacancy and leasing times locally (PropTrack, 2025).
...
## What the Data Shows
- Expansion: Falling DOM and tightening listings often precede broader price gains.
- Slowdown: DOM lengthens, listings build, rent momentum softens first in vulnerable stock types.
- Repair: Stabilising vacancy and listings with steady rents mark early repair phases even if prices are flat.
...
- Policy & Tenancy: State rule changes (tenancy, short‑stay) affect holding costs and leasing dynamics; confirm timing and scope.
- Supply shocks: Rapid approval/release cycles can swing conditions; track ABS approvals and local completions.
- Migration & Employment: Demand shifts with flows and job markets; watch ABS and RBA commentary.
- Cost & Rates: Assessment rate changes and funding costs affect buyer depth; follow RBA and lender updates.
