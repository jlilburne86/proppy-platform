---
title: "Units vs Houses: How Performance Has Changed Over the Decade"
description: "A data‑first view on units vs houses—yield vs growth, where stock mix matters, and how to read vacancy, listings and approvals in each segment."
category: [Strategy]
audience: [Both]
reading_time: "5 min"
...
Stock type matters. Houses and units respond differently to rents, supply and borrowing conditions. This article compares the segments, highlights where exceptions live, and offers a practical dashboard to guide decisions.
...
## Market Context
- Houses tend to lead cycles in scarcity‑constrained inner/middle rings; units can offer better entry yields and cyclical catch‑ups where vacancy is tight and new supply is limited.
- In high‑construction pockets, unit performance depends heavily on completions and investor turnover; house results hinge on land scarcity and micro‑location quality (ABS/PropTrack/CoreLogic, 2024–2025).
...
## What the Data Shows
- Units: Higher entry yields in select inner/middle rings where vacancy is tight and supply pipelines are limited; watch owners corp quality and strata levies.
- Houses: Scarcity of well‑located land supports price resilience; rental uplift depends on bedroom mix, condition and amenity.

## 🔍 Proppy Data Lens
| Signal              | Recent Read (mm/yyyy) | Direction | Why it matters |
|---------------------|------------------------|-----------|----------------|
| Vacancy             | (12/2025)             | ↘/→       | Tight vacancy supports rental uplift in both segments. |
| Rents (YoY)         | (2025)                | ↗/→       | Yield stabilisers for units; supports house holding buffers. |
| Listings (YoY)      | (Q4/2025)             | ↘/→       | Scarcity aids houses first; unit effect varies by pipeline. |
| DOM                 | (Q4/2025)             | ↘/→       | Faster selling/letting indicates stronger demand depth. |
| Building approvals  | (2025)                | ↘         | Lower pipelines favour both where demand persists. |
| Investor lending    | (2025)                | →         | Segment competition shifts with investor participation. |
...
- Policy & Tenancy: State‑level rental rule changes and short‑stay regulation; track compliance costs (bond, notice, minimum standards).
- Supply shocks: Completion waves in unit‑heavy pockets can loosen rents; track approvals and pre‑sales risk.
- Migration & Employment: Demand around universities, hospitals and employment nodes shifts leasing depth (ABS/PropTrack commentary).
- Cost & Rates: Funding costs and assessment rates change investor participation; monitor RBA and lender pricing.
