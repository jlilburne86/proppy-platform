---
title: "Yield vs Capital Growth: Finding the Balance"
description: "Balance cashflow and equity with a multi‑signal framework—vacancy, rents, listings, DOM, approvals—and practical calculations investors can reuse."
category: [Strategy]
audience: [Both]
reading_time: "5 min"
...
Growth compounds equity; yield funds holding. This article shows how to trade off the two based on cycle position, borrowing capacity, and risk tolerance using vacancy, rents, listings, DOM and supply—then turns it into investor actions.
...
## Market Context
- Monetary settings eased from 2024 peaks. The RBA cash rate target was 3.60% in Dec 2025 after reductions earlier that year (RBA, 10 Dec 2025).
- Dwelling approvals remained well below 2021 peaks through 2024–2025 in many states, constraining medium‑term supply where demand persists (ABS, 2024–2025).
- Rental markets across several corridors stayed tight, supporting yields even where prices moved sideways (PropTrack, 2025).
...
## What the Data Shows
- Long‑run (10–20y): Compounding and holding quality assets through cycles dominate outcomes (CoreLogic long‑run indexes).
- 12–24m: Some corridors show strong rent growth with modest price gains; others the reverse (PropTrack/CoreLogic, 2024–2025). Treat city medians as context only—suburb‑level signals matter most.
- Last 1–3 quarters: Listings, vacancy, and approvals provide near‑term signal; confirm across multiple prints to avoid noise.

## 🔍 Proppy Data Lens
| Signal              | Recent Read (mm/yyyy) | Direction | Why it matters |
|---------------------|------------------------|-----------|----------------|
| Vacancy             | (12/2025)             | ↘/→       | Tight vacancy supports yields and leasing certainty. |
| Rents (YoY)         | (2025)                | ↗/→       | Rent growth boosts gross yield and buffers. |
| Listings (YoY)      | (Q4/2025)             | ↘/→       | Scarcity can support prices; rising stock can loosen conditions. |
| DOM                 | (Q4/2025)             | ↘/→       | Faster sales often signal stronger buyer depth. |
| Building approvals  | (2025)                | ↘         | Lower approvals today can mean tighter future rentals. |
...
- Policy & Tenancy: State‑level rental rule changes and short‑stay regulation; monitor implementation timing and compliance costs.
- Supply shifts: Catch‑up in approvals/completions can temper rents; track ABS approvals and local pipeline updates.
- Migration & Employment: Changes in interstate/overseas flows and labour markets alter rental pressure (ABS/RBA updates).
- Cost & Rates: Funding costs and assessment rates change buyer depth; track RBA decisions and lender pricing.
