---
title: "Capital Growth vs Rental Yield: Understanding the Trade-Offs"
description: "A data‑led guide to capital growth vs rental yield: understanding the trade-offs — using vacancy, rents, listings, DOM and supply signals to translate analysis…"
...
Growth compounds equity; yield funds holding. This article examines capital growth vs rental yield: understanding the trade-offs with a repeatable, multi‑signal approach—vacancy, rents, listings, days on market, and supply—then turns it into investor actions.
