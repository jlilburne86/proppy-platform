---
title: "Diversification in Property: Cities, States and Asset Types"
description: "A data‑led guide to diversification in property: cities, states and asset types — using vacancy, rents, listings, DOM and supply signals to translate analysis…"
category: [Strategy]
audience: [Both]
reading_time: "5 min"
...
Growth compounds equity; yield funds holding. This article examines diversification in property: cities, states and asset types with a repeatable, multi‑signal approach—vacancy, rents, listings, days on market, and supply—then turns it into investor actions.
