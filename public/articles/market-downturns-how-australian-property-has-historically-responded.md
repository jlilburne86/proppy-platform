---
title: "Market Downturns: How Australian Property Has Historically Responded"
description: "How Australian housing has historically behaved in downturns—signals that deteriorate first, what stabilises, and the process investors can reuse."
...
Downturns are part of the cycle. This article reviews typical patterns—what weakens first, where resilience shows up—and offers a disciplined, data‑first process to navigate them.
...
## Market Context
- Financing costs: The RBA cash rate target was 3.60% on 10 Dec 2025 after earlier cuts in 2025 (RBA). Easing helps serviceability but doesn’t remove structural supply/demand constraints.
- Supply response: Approvals and commencements were below 2021 peaks into 2025 in many jurisdictions (ABS). Slow pipelines can cushion rentals in downturns.
- Demand signals: Vacancy and DOM typically adjust before price indexes; read them first and at suburb level (PropTrack/CoreLogic, 2024–2025).
...
## What the Data Shows
- In slowdowns, listings often build first; price falls, if any, tend to be uneven and concentrated in over‑supplied or lower‑quality stock.
- Tight vacancy can limit rent declines even when transaction volumes soften; outer‑ring new‑build pockets behave differently to inner‑ring established stock.
- Recovery phases are marked by stabilising listings and shorter DOM before prices broadly follow.

## 🔍 Proppy Data Lens
| Signal              | Recent Read (mm/yyyy) | Direction | Why it matters |
|---------------------|------------------------|-----------|----------------|
| Vacancy             | (12/2025)             | ↘/→       | Tight vacancy cushions rents during softer sales periods. |
| Rents (YoY)         | (2025)                | →         | Flat or modest growth supports holding buffers. |
| Listings (YoY)      | (Q4/2025)             | ↗/→       | Rising stock can pressure prices; track absorption. |
| DOM                 | (Q4/2025)             | ↗         | Longer selling times are an early warning. |
| Building approvals  | (2025)                | ↘         | Slower pipelines can aid rental tightness later. |
...
- Policy & Tenancy: Rule changes (notice periods, standards, short‑stay caps) can influence leasing and costs.
- Supply shocks: If approvals/completions catch up quickly, rental tightness can ease; track ABS and local project updates.
- Migration & Employment: University and industry cycles shift tenant demand; review ABS and RBA commentary.
- Cost & Rates: Funding costs and assessment rates change buyer depth; monitor RBA decisions and lender pricing.
